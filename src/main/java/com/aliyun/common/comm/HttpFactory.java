...
class HttpFactory {
          ...
          if (method == HttpMethod.DELETE) {
            ...
            if (method == HttpMethod.HEAD) {
              ...
              throw new IllegalArgumentException(String.format("Unsupported HTTP method：%s.",
                  new Object[] {request.getMethod().toString()}));
          }
        }
      }
    }
  ...
  private void configureRequestHeaders(ServiceClient.Request request, ExecutionContext context,
    ...
    if ((httpRequest.getHeaders("Content-Type") == null)
      ...
      httpRequest.addHeader("Content-Type", "application/x-www-form-urlencoded; charset="
          + context.getCharset().toLowerCase());
    }
  }
 ...
 * Qualified Name: com.aliyun.common.comm.HttpFactory JD-Core Version: 0.7.0-SNAPSHOT-20130630
 */
