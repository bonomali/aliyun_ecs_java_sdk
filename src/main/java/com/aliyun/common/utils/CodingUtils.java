...
public class CodingUtils {
  ...
  public static void assertParameterNotNull(Object param, String paramName) {
    if (param == null) {
      throw new NullPointerException(rm.getFormattedString("ParameterIsNull",
  ...
  public static void assertStringNotNullOrEmpty(String param, String paramName) {
    ...
    assert (param != null);
    if (param.length() == 0) {
      throw new IllegalArgumentException(rm.getFormattedString("ParameterStringIsEmpty",
          new Object[] {paramName}));
    }
  }
 ...
 * Qualified Name: com.aliyun.common.utils.CodingUtils JD-Core Version: 0.7.0-SNAPSHOT-20130630
 */
